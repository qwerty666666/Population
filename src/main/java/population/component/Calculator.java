...
public class Calculator {
    ...
    private final boolean mPrepareResultsTableData; //  результат в графическом виде
    private volatile double mProgress; // Прогресс вычислений
    private int mCurStep = 1;   // current calculation step (used oПодготовить результат в табличном виде
    private final boolean mPrepareResultsChartData; // Подготовитьnly in step by step calculation)
